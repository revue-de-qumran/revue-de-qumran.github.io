<template>
    ...
    <v-row justify="center" class="d-flex flex-column flex-md-row">
        ...
        <v-col class="bg-primary pa-16" col="12"  md="8">
                ...
                <p>Frédérique Michèle Rey, Université de Lorraine</p>
                <br />
                <h2>Secrétaire</h2>
                <p>Eric Reymond, Yale University</p>
                <br />
                <h2>Responsable des recensions</h2>
                <p>Atar Livneh, Ben Gourion University of the Negev</p>
                <br />
                <h2>Corrections typographiques</h2>
                <p>Jeremy Penner, University of Cambridge</p>
                <br />
                <h2>Conseil Académique</h2>
                <p>
                ...
                Noam Mizrahi, The Hebrew University of Jerusalem<br />
                Dennis Mizzi, University of Malta<br />
                Hindy Najman, University of Oxford<br />
                Émile Puech, CNRS<br />
